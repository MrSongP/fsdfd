...
def parse_args(script):
    ...
    parser.add_argument('--method', default='OurNet',
                        help='relationnet/CosineBatch/OurNet')  # relationnet_softmax replace L2 norm with softmax to expedite training, maml_approx use first-order approximation in the gradient for efficiency
    # todo ======
